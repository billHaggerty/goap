...
main() async {
  group('A group of tests', () {
    LumberjackAction buyAxe;
    LumberjackAction improveAxe;
    LumberjackAction chopWood;
    LumberjackAction chopWoodBetter;
    LumberjackAction sellWood;
    LumberjackAction stealGold;
    LumberjackDream goal;
    Planner<LumberjackAction> planner;
